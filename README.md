...
<head>
    ...
    <title> أولمبياد فيزياء اللاذقية</title>
    <style>
        :root {
            --bg-color: #9FD3BF;
            --text-color: #333;
        ...
        * {
        ...
        .add-resource {
            display: none; /* Hidden from viewers */
            margin-top: 1rem;
            padding: 0.8rem;
            background-color: #e8f5e9;
...
<body>
    <header>
        ...
        <br>المشروع غير مكتمل حتى الان و بعض الملفات المنشورة هي مسودات و يتم حتى الان العمل على اعادة تنسيقها او اعادة صياغتها كلها و قد تكون مكتملة بحلول عام 2026؛ نتمنى ان تفيدكم </p>
        </div>
    </header>
    
    <main class="container">
        <section class="main-section">
            <h2 class="section-title">الملخصات الدراسية</h2>
            <div class="topics-container">

                           <div class="topic-box">
                    <h3 class="topic-title">الرياضيات التفاضلية و التكاملية</h3>
                    ...
                    <div class="add-resource">+ إضافة ملخص جديد</div>
                </div>

                <div class="topic-box">
                    <h3 class="topic-title">الميكانيكا</h3>
                    <ul class="resource-list">
                ...
                <div class="topic-box">
                    <h3 class="topic-title">الكهرباء والمغناطيسية</h3>
                    <ul class="resource-list">
                ...
                <div class="topic-box">
                    <h3 class="topic-title">الديناميكا الحرارية</h3>
                    <ul class="resource-list">
                ...
                <div class="topic-box">
                    <h3 class="topic-title">النسبية</h3>
                    <ul class="resource-list">
                        <!-- EDIT HERE: Add your files/links -->
                    </ul>
                    <div class="add-resource">+ إضافة ملخص جديد</div>
                </div>
                
                <div class="topic-box">
                    <h3 class="topic-title">الفيزياء الحديثة</h3>
                    <ul class="resource-list">
                        <a href="https://drive.google.com/file/d/1-Lyp0Q3dtRpcAwOfrbkClxa7gNC1G7R_/view?usp=sharing" target="_blank">ملخص نسبية </a><br>
                <a href="https://drive.google.com/file/d/13XhaUy0y1F3pWEEmQol0LtP_4RbQInxt/view?usp=sharing" target="_blank">ملخص ميكانيك الكم  </a>
                </p>
                    </ul>
                    <div class="add-resource">+ إضافة ملخص جديد</div>
                </div>
        ...
        <section class="main-section">
            ...
            <div class="topics-container">
                <div class="topic-box">
                    ...
                    <div class="add-resource">+ إضافة اختبار جديد</div>
                </div>
